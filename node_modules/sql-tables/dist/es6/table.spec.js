import { createInsertQuery, createPgQuery, createQueryObservable, createQueryStream, createReduceCompoundInsertOrSelectResults, getClientFrom, hasQueryError, isValidResult, reduceByKeys, validatePropValsForInput, } from './table';
describe('table specs', () => {
    ...
    describe('createPgQuery function', () => {
        it('should call the query with params if given params', (done) => {
            ...
            expect(createPgQuery({ query: qf }, 'hello', params));
        });
        it('should call the query without params if not given params', (done) => {
            ...
            expect(createPgQuery({ query: qf }, 'hello'));
        });
    });
    ...
    describe('createReduceCompoundInsertOrSelectResults function', () => {
        it('should throw if there are any errors', () => {
            expect(() => createReduceCompoundInsertOrSelectResults(['col1', 'col2'])([[], []])).toThrowError();
        });
        it('should return a list of ids if everything is good', () => {
            expect(createReduceCompoundInsertOrSelectResults(['col1', 'col2'])([[{ id: 1 }], [{ id: 2 }]])).toEqual([1, 2]);
        });
    });
    ...
    describe('isValidResult function', () => {
        ...
        it('should return false if there is no rows object', () => {
            expect(isValidResult({})).toEqual(false);
        });
        it('should return false if the rows object is not an array', () => {
            expect(isValidResult({ rows: {} })).toEqual(false);
        });
        ...
        it('should return true if the rows object is an array with length', () => {
            expect(isValidResult({ rows: [{}] })).toEqual(true);
        });
    });
