...
import { createCrIterator, createReferences, createStructIterator, createTableFromStruct, isConstraint, mutateStructIntoSchemaStructs, strictifySchemaItem, } from './fixer-functions';
describe('Maintainer Fixer functions', () => {
    ...
    describe('createStructIterator function', () => {
        it('if there is no relation the iterator should return state', () => {
            ...
            expect(createStructIterator({}, noop, 'key')(state, { type: 'String' })).toEqual(state);
        });
        it('if there is a dependent ancestor throw', () => {
            ...
            expect(() => createStructIterator({}, noop, 'key')(state, {
        ...
        it('if the item is not an ancestor and is not checked and exists in the ' +
            ...
            createStructIterator({ thing: { struct: {} } }, (s, scProp) => {
        ...
        it('if the item is not an ancestor and is not checked and exists in the ' +
            ...
            expect(createStructIterator({ thing: { struct: {} } }, noop, 'key')(state, {
                relation: { prop: 'any', struct: 'thing' },
                type: 'String',
            })).toEqual(state);
        });
